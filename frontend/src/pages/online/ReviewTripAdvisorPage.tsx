...
export const ReviewTripAdvisorPage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
      <div className="relative">
        <div className="w-24 h-24 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
          <Construction className="w-12 h-12 text-emerald-600 dark:text-emerald-400 animate-pulse" />
        </div>
      ...
      <div className="max-w-md text-center space-y-4">
        <div className="p-4 rounded-lg bg-stone-100 dark:bg-stone-800 border border-stone-200 dark:border-stone-700">
          <p className="text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
            Lucrăm la integrarea cu TripAdvisor pentru a afișa și gestiona recenziile dvs. de pe TripAdvisor.
          </p>
        </div>
